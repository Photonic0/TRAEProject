...
namespace TRAEProject.Changes
{
    public class Mana : ModPlayer
    {
        ...
        {
            IL_Player.ItemCheck_PayMana += PayManaHook2; //this method is used by most magic weapons
            IL_Player.CheckMana_Item_int_bool_bool += CheckManaHook2; //this is used by held projectiles like LMG
        }
