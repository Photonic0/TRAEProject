...
namespace TRAEProject.NewContent.Projectiles
{
    public class LilRocket : ModProjectile
    {
        ...
        {       
            ...
            {
                int num369 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 229, 0f, 0f, 200, default, 2.5f);
                Main.dust[num369].noGravity = true;
                Dust dust = Main.dust[num369];
                dust.velocity *= 2f;
                num369 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 229, 0f, 0f, 200, default, 1.5f);
