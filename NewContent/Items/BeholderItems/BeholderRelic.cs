...
{
	public class BeholderRelicItem : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            Item.DefaultToPlaceableTile(ModContent.TileType<BeholderRelic>(), 0);
			Item.width = 68;
			Item.height = 96;
			Item.maxStack = 99;
	...
	public class BeholderRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TRAEProject/NewContent/Items/BeholderItems/BeholderRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TRAEProject/NewContent/Items/BeholderItems/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<BeholderRelicItem>();
					break;
	...
	public class MyBossRelic : MinionBossRelic
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 32, ModContent.ItemType<NewContent.Items.Placeable.Furniture.MyBossRelic>());
		}
	}
	*/
