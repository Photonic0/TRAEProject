    ...
    public class GraniteOvergrowth : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement>
            {
                ...
                new FlavorTextBestiaryInfoElement("A sentient tumor, neverendlessly feeding off the bioelectricity and nutrients generated by the Granite Caves. It is extremely aggressive, as it must constantly release energy else it would explode")
            });
        }
        ...
        public override void AI()
        {
            ...
            {
                if (NPC.ai[1] % 240 == 0 && NPC.ai[1] < 900)
                {
                    NPC.HealEffect(NPC.Hitbox, 1000, true);
                }
        ...
        public override void AI()
        {
            ...
            for (int index1 = 0; index1 < 255; index1++)
            {
                if (index1 >= 0 && Main.player[index1].active && !Main.player[index1].dead)
                {
                    ...
                    if (unitY.HasNaNs())
                        unitY = Vector2.UnitY;
                    NPC.velocity = Vector2.Multiply(unitY, 3f);
                }
            }
        }
    }
