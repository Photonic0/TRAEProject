...
{
    public class TridentThrown: ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("TridentThrown");     //The English name of the Projectile
        }
        ...
        {
            Terraria.Audio.SoundEngine.PlaySound(SoundID.Dig, (int)Projectile.position.X, (int)Projectile.position.Y); // Play a death sound
        ...
        public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
        {
            damage *= 16;
            damage /= 10;
            target.AddBuff(BuffID.BoneJavelin, 900); // Adds the ExampleJavelin debuff for a very small DoT
        ...
        private void UpdateStickyJavelins(NPC target)
        {
            ...
            for (int i = 0; i < Main.maxProjectiles; i++) // Loop all Projectiles
            {
                ...
                if (i != Projectile.whoAmI // Make sure the looped Projectile is not the current javelin
                    ...
                    && currentProjectile.ModProjectile is TridentThrown javelinProjectile // Use a pattern match cast so we can access the Projectile like an ExampleJavelinProjectile
