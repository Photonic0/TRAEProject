...
namespace TRAEProject.Items.DreadItems.DreadRelic
{
	...
	public class DreadRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TRAEProject/Items/DreadItems/DreadRelic/DreadRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TRAEProject/Items/DreadItems/DreadRelic/RelicPedestal";
